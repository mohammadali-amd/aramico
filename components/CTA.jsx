...
const CTA = () => {
  ...
  return (
    <aside className="fixed gap-10 z-20 hidden md:block">
      <div className="fixed right-0 top-[12rem] ">
        <Link href={"tel:02142167000"} className={`${style} hover:pr-44`}>
          <Image src={cta_phone} width={28} alt="phone number" />
          <span className="absolute left-16 -right-28 text-lg">
            021-42167000
          </span>
        </Link>
      </div>

      <div className="fixed right-0 top-[17rem]">
        <Link
          href={"mailto:info@arami-co.com"}
          className={`${style} hover:pr-48`}>
          <Image src={cta_email_open} width={28} alt="email address" />
          <div className="absolute left-16 text-base -right-36">
            info@arami-co.com
          </div>
        </Link>
      </div>
      ...
      <div className="fixed right-0 top-[22rem]">
        <Link href={"/"} className={`${style} hover:pr-28`}>
          <Image src={cta_chat_message} width={28} alt="contact us" />
          <div className="absolute left-16 text-base -right-36">Support</div>
        </Link>
      </div>

      <div className="fixed right-0 top-[27rem]">
        <Link href={"/"} className={`${style} hover:pr-32`}>
          <Image src={cta_broshures} width={28} alt="brochures" />
          <div className="absolute left-16 text-base -right-36">Brochures</div>
        </Link>
      </div>

      <div className="fixed right-0 top-[32rem]">
