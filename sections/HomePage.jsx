  ...
  return (
    <div>
      ...
      <section className='mt-[8rem] md:mt-0 page-layout'>
          <h1 className='text-3xl md:text-5xl mt-8'>Industrial & Engineering Projects Implementation</h1>
          <Divider width='36' className="my-3" />
          ...
          <p className='py-10 text-base text-text'>
            <b>ARAMICO</b> is a trustworthy brand for providing industrial solutions and services. Our process is based on finding opportunities, research and development, implementing projects at the laboratory and pilot level and implementing projects with suitable economic parameters on an industrial scale. We are ready to cooperate with our customers to launch industrial projects in various fields.
          </p>

          <ul className='space-y-3'>
            <li className='flex align-middle gap-5'>
              <span className='mt-[2px]'><Image src={tick_box} alt='check box' width={17}/></span>
              <span>
                <b>Mining industries:</b> Enrichment and concentration of minerals, Crushing and granulation lines, Calcination and roasting of minerals, etc.
              </span>
            </li>
            <li className='flex align-middle gap-5'>
              <span className='mt-[2px]'><Image src={tick_box} alt='check box' width={17}/></span>
              <span>
                <b>Metallurgical industries:</b> Production of magnesium ingots from dolomite ore, Production of cathode copper, Production of calcined alumina (Alpha), Production of fused alumina and mullite, Production of sponge iron using tunnel furnace, Centrifugal casting, etc.
              </span>
            </li>
            <li className='flex align-middle gap-5'>
              <span className='mt-[2px]'><Image src={tick_box} alt='check box' width={17}/></span>
      ...
      <div className="bg-gray-200 grid grid-cols-1 gap-1 text-center py-8 my-10">
          ...
          <div>
            <span className='text-[20px] md:text-[24px]'>For quality, consistency, and our customers’ trust!</span>
          </div>
          <div className='flex justify-center'>
            <Divider mb='0' width='40' />
          </div>
